...
<div class='group'>
    <div class='left' style='position: absolute; top: 12px; background-color:rgb(51, 103, 153)'><img src='../images/logo.png' syle=' margin-top: 0px; margin-left: 15px ! important;'>
        	...
        	<div class='right1'><table width='100%' border='0' cellspacing='5px;' style='margin-top:10px'>   
     					<tr>
						<td rowspan='3' width='100px' align='center'><img src='/BDL/siswa/images/avatar.png' height='60px' width='60px' style=' margin-left:0px; margin-top:5px' class='foto'> </td>
...
<div id="isi"><div class="grup" style="width:95%; margin:0 auto; margin-top:25px">
<div class="kiri">
 <div class="list-group-item top-heading">
<h3 class="list-group-item-heading page-label">Daftar Ujian</h3></div><div class="alert alert-info"><table class="table table-striped"><thead>
   <tr>
      <th>No</th>
	  <th>Judul</th>
      <th>Pelajaran</th>
      <th>Aksi</th>
		 ...
		 <td><h2>UTS</h2></td>
         <td><h2>IPA</h2></td>
        <td bgcolor="bordercolordark=&quot;#00FF33&quot;"><a onclick="show_nilai(1)" class="btn btn-block">Lihat Nilai</a></td>
